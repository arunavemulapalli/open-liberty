...
public class Saml20TokenImplSerializationTest {
    ...
    public void deserializeSaml20Token_1() throws Exception {
        String filename = "test-resources/ser-files/Saml20TokenImpl_1.ser";
        FileInputStream file = new FileInputStream(filename);
        ObjectInputStream in = new ObjectInputStream(file);

        Saml20TokenImpl object = (Saml20TokenImpl) in.readObject();

        in.close();

        //Check serializationVersion via reflection
        Field field = Saml20TokenImpl.class.getDeclaredField("serialVersionUID");
        field.setAccessible(true);
        Object value = field.get(object);
        assertEquals("The version should be -862850937499495719L", -862850937499495719L, value);

        //Check samlString
        //This is used to populate all the other fields of Saml20TokenImpl.
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filename = "test-resources/ser-files/Saml20TokenImpl_x.ser";
